...
BGT_CLAIM_ADDRESS = Web3.to_checksum_address('0x2E8410239bB4b099EE2d5683e3EF9d6f04E321CC')
...
BGT_CLAIM_CONTRACT = BERA.eth.contract(address=Web3.to_checksum_address(BGT_CLAIM_ADDRESS), abi=BGT_CLAIM_ABI)
...
class Task(QLTask):
    def task(self, index: int, datas: list[str], proxy: str, logger):
        ...
        try:
            ...
            method = BGT_CLAIM_CONTRACT.functions.getReward(account.address)
